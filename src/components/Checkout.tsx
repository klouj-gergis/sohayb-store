      ...
      <form onSubmit={() => {
        ...
        </div>
        {
          checkoutData.payment_method !== 'cod' && <div className="w-full mx-11 flex flex-col gap-1">
            <hr />
            <p className="text-sm text-center text-dark-accent">Send the total payment ammount to this {checkoutData.payment_method} number: <span className="text-lg font-semibold">{checkoutData.receiver}</span> after that you can enter the sender Number</p>
