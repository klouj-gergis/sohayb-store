...
export default function About(){
    ...
    return (
        <section className="w-full flex flex-col lg:flex-row items-center justify-center bg-dark-accent p-10">
            ...
            <div className="w-full lg:w-3/6 flex flex-col items-center lg:items-start  py-5 px-10 gap-5">
                <h3 className="text-3xl text-bg font-bold w-full">
                    {
                        storeData.about.title
                    }
                </h3>
                <p className="text-xl text-center lg:text-left text-bg/80">
                    {
